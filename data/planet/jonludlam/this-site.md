...
{|style="fill:lime;stroke:purple;stroke-width:5;"/&gt;&lt;/svg&gt;|}];;</x-ocaml></p>
...
<p><x-ocaml mode="interactive">type t = { foo : int; bar : string };;</x-ocaml></p>
<p>let x = { foo = 1; bar = "hello" };;</p>
<p>let this_line_has_an_error = { foo = 1; bar = None };;
