...
description: "When I started to play with OCaml I was kind of surprised that there
  ...
  auto-opened). A quick search led me to the Fun module, which is part of the standard
  library and is nested under Stdlib. It was introduced in OCaml 4.08, alongside other
  modules such as Int, Result and Option.1 It was part of some broader efforts to
  slim down Stdlib and move in the direction of a more modular standard library.\_\u21A9&#xfe0e;"
...
modules such as <code class="language-plaintext highlighter-rouge">Int</code>, <code class="language-plaintext highlighter-rouge">Result</code> and <code class="language-plaintext highlighter-rouge">Option</code>.<sup><a href="https://batsov.com/feeds/OCaml.xml#fn:1" class="footnote" rel="footnote" role="doc-noteref">1</a></sup></p>
...
that OCaml’s team has been working towards in the past several years.<sup><a href="https://batsov.com/feeds/OCaml.xml#fn:2" class="footnote" rel="footnote" role="doc-noteref">2</a></sup> The important
...
<div class="footnotes" role="doc-endnotes">
  <ol>
    <li>
      <p>It was part of some broader efforts to slim down <code class="language-plaintext highlighter-rouge">Stdlib</code> and move in the direction of a more modular standard library.&nbsp;<a href="https://batsov.com/feeds/OCaml.xml#fnref:1" class="reversefootnote" role="doc-backlink">↩︎</a></p>
    </li>
    <li>
      <p>And obviously you can open the <code class="language-plaintext highlighter-rouge">Fun</code> module if you wish to at whatever level you desire.&nbsp;<a href="https://batsov.com/feeds/OCaml.xml#fnref:2" class="reversefootnote" role="doc-backlink">↩︎</a></p>
    </li>
  </ol>
</div>
