...
---
        ...
        <h1>I Cannot SSH Into My Server Anymore (And That’s Fine)</h1><div><span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/coreos.html" class="tag hover-sky" marked="">coreos</a> <span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/docker.html" class="tag hover-peach" marked="">docker</a> <span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/meta.html" class="tag hover-lavender" marked="">meta</a> <span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/self-hosting.html" class="tag hover-rose" marked="">self-hosting</a> <span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/terraform.html" class="tag hover-mint" marked="">terraform</a> <span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/vultr.html" class="tag hover-periwinkle" marked="">vultr</a> </div>
<blockquote>
...
mirrors behind this magic trick: <a href="https://fedoraproject.org/coreos/" class="hover-sky" marked="">Fedora CoreOS&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a>, <a href="https://coreos.github.io/ignition/" class="hover-periwinkle" marked="">Ignition&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#github"></use></svg></span></a> and <a href="https://docs.podman.io/en/latest/markdown/podman-quadlet.1.html" class="hover-lavender" marked="">Podman
Quadlets&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> in the main roles, with <a href="https://developer.hashicorp.com/terraform" class="hover-mint" marked="">Terraform&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> as an essential supporting
character. This stack checks all the boxes I care about.</p>
<div class="markdown-alert markdown-alert-note"><p class="markdown-alert-title"><svg class="octicon octicon-info mr-2" viewbox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM6.5 7.75A.75.75 0 0 1 7.25 7h1a.75.75 0 0 1 .75.75v2.75h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1 0-1.5h.25v-2h-.25a.75.75 0 0 1-.75-.75ZM8 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>Note</p><p>For interested readers, I have published <code class="hljs">tinkerbell</code>’s <a href="https://github.com/lthms/tinkerbell" class="hover-periwinkle" marked="">full setup&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#github"></use></svg></span></a> on
...
me to create interconnected <a href="https://man7.org/linux/man-pages/man5/systemd.nspawn.5.html" class="hover-peach" marked="">nspawn containers&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> on the spot. </span>
...
<p><a href="https://docs.docker.com/compose/" class="hover-lemon" marked="">Docker Compose&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> alone wasn’t a good fit. I like compose files, but one needs
...
files into <a href="https://helm.sh/docs/topics/charts/" class="hover-mint" marked="">Helm charts&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> and be done with it. If I could do the same thing,
...
<p><a href="https://fedoraproject.org/coreos/" class="hover-coral" marked="">CoreOS&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a>, being an operating system specifically built to <em>run containers</em>,
...
<a href="https://docs.podman.io/en/stable/markdown/podman-auto-update.1.html" class="hover-peach" marked="">auto-updates&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a>.</p>
...
when I heard <a href="https://caddyserver.com/" class="hover-mint" marked="">Caddy&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> could “<em>automatically obtain</em> and <em>renew</em> TLS
...
able to interact with the Vultr API, using the <a href="https://registry.terraform.io/providers/vultr/vultr/latest/docs" class="hover-mint" marked="">Vultr provider&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a>. Second, I
...
Quadlet, whose <a href="https://github.com/containers/quadlet" class="hover-sky" marked="">initial repository does a good job justifying its
...
configurations are automatically generated (using <a href="https://github.com/containers/quadlet" class="hover-rose" marked="">systemd generators&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#github"></use></svg></span></a>).</p>
</blockquote>
