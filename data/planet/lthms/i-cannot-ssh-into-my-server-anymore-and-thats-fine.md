...
---
        ...
        <h1>I Cannot SSH Into My Server Anymore (And That’s Fine)</h1><div><span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/coreos.html" class="tag hover-lemon" marked="">coreos</a> <span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/docker.html" class="tag hover-periwinkle" marked="">docker</a> <span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/meta.html" class="tag hover-rose" marked="">meta</a> <span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/self-hosting.html" class="tag hover-coral" marked="">self-hosting</a> <span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/terraform.html" class="tag hover-peach" marked="">terraform</a> <span class="icon"><svg><use href="/~lthms/img/icons.svg#tag"></use></svg></span>&nbsp;<a href="https://soap.coffee/~lthms/tags/vultr.html" class="tag hover-sky" marked="">vultr</a> </div>
<blockquote>
...
mirrors behind this magic trick: <a href="https://fedoraproject.org/coreos/" class="hover-periwinkle" marked="">Fedora CoreOS&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a>, <a href="https://coreos.github.io/ignition/" class="hover-peach" marked="">Ignition&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#github"></use></svg></span></a> and <a href="https://docs.podman.io/en/latest/markdown/podman-quadlet.1.html" class="hover-rose" marked="">Podman
...
<div class="markdown-alert markdown-alert-note"><p class="markdown-alert-title"><svg class="octicon octicon-info mr-2" viewbox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM6.5 7.75A.75.75 0 0 1 7.25 7h1a.75.75 0 0 1 .75.75v2.75h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1 0-1.5h.25v-2h-.25a.75.75 0 0 1-.75-.75ZM8 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"></path></svg>Note</p><p>For interested readers, I have published <code class="hljs">tinkerbell</code>’s <a href="https://github.com/lthms/tinkerbell" class="hover-lemon" marked="">full setup&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#github"></use></svg></span></a> on
...
in a nutshell: everything relied on <a href="https://github.com/lthms/nspawn" class="hover-coral" marked="">a small script&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#github"></use></svg></span></a> that enabled
me to create interconnected <a href="https://man7.org/linux/man-pages/man5/systemd.nspawn.5.html" class="hover-lavender" marked="">nspawn containers&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> on the spot. </span>
...
service deployed on <code class="hljs">moana</code> that I really wanted to keep. Since <a href="https://soap.coffee/~lthms/posts/DreamWebsite.html" class="hover-periwinkle" marked="">I had written
...
<p><a href="https://docs.docker.com/compose/" class="hover-mint" marked="">Docker Compose&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> alone wasn’t a good fit. I like compose files, but one needs
...
<p><a href="https://kubernetes.io/" class="hover-coral" marked="">Kubernetes&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> was <em>very</em> appealing on paper. I have seen engineers turn compose
files into <a href="https://helm.sh/docs/topics/charts/" class="hover-lemon" marked="">Helm charts&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> and be done with it. If I could do the same thing,
...
<p><a href="https://fedoraproject.org/coreos/" class="hover-lavender" marked="">CoreOS&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a>, being an operating system specifically built to <em>run containers</em>,
...
<a href="https://docs.podman.io/en/stable/markdown/podman-auto-update.1.html" class="hover-sky" marked="">auto-updates&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a>.</p>
...
when I heard <a href="https://caddyserver.com/" class="hover-sky" marked="">Caddy&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> could “<em>automatically obtain</em> and <em>renew</em> TLS
...
with close to zero overhead using the <a href="https://hub.docker.com/_/scratch" class="hover-peach" marked=""><code class="hljs">scratch</code>&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a> base image, so I
...
able to interact with the Vultr API, using the <a href="https://registry.terraform.io/providers/vultr/vultr/latest/docs" class="hover-peach" marked="">Vultr provider&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a>. Second, I
needed to <a href="https://registry.terraform.io/providers/vultr/vultr/latest/docs/resources/instance" class="hover-periwinkle" marked="">create the VM&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a><label for="fn7" class="sidenote-number margin-toggle"></label><input type="checkbox" class="margin-toggle"><span class="note-right sidenote note"><span class="footnote-p">For discovering what values to put in most fields, <code class="hljs">vultr-cli</code> is
...
Quadlet, whose <a href="https://github.com/containers/quadlet" class="hover-lemon" marked="">initial repository does a good job justifying its
...
configurations are automatically generated (using <a href="https://github.com/containers/quadlet" class="hover-coral" marked="">systemd generators&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#github"></use></svg></span></a>).</p>
</blockquote>
...
other was to introduce a <a href="https://docs.podman.io/en/latest/_static/api.html?version=latest#tag/pods" class="hover-mint" marked=""><em>pod</em>&nbsp;<span class="icon"><svg><use href="/~lthms/img/icons.svg#external-link"></use></svg></span></a>. Unlike Docker Compose which uses DNS
